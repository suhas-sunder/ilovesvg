...
assertIncludes(waitlist, "appendOptionalPayloadField", "empty optional payload omission");
assertIncludes(waitlist, "country_or_region", "country or region field");
assertIncludes(waitlist, "waitlist-country", "country input");
assertIncludes(waitlist, 'autoComplete="country-name"', "country browser autofill");
