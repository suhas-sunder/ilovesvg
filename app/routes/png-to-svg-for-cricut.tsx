...
import type { Route } from "./+types/png-to-svg-for-cricut";
import {
  json,
...
export function meta({}: Route.MetaArgs) {
  ...
  return [
    ...
    { name: "theme-color", content: "#0b2dff" },
    {
      name: "keywords",
      content:
        "png to svg for cricut, cricut svg converter, png to svg cricut, jpg to svg for cricut, cricut cut file maker, single color svg, svg for cricut design space, image to svg for cricut",
    },
...
const routeCapabilities = getRouteCapabilities("png-to-svg-for-cricut");
...
function autoModeHint(mode: AutoMode): string {
  if (mode === "medium")
    return "Live preview is throttled for 10-25 MB craft files.";
  return "";
}
function autoModeDetail(mode: AutoMode): string {
  if (mode === "medium")
    return "Large artwork updates run less frequently to keep the converter stable.";
  return "";
}
              ...
              <div className="flex items-center gap-3 mt-3 flex-wrap">
                ...
                >
                  <Icons
                    ...
                    title="Convert"
                  />
                  {busy ? "Converting…" : "Convert to Cut SVG"}
                </button>
            ...
            <div className="bg-slate-600 border border-slate-200 rounded-xl p-4 h-full max-h-[124.25em] overflow-auto shadow-sm min-w-0">
              ...
              {history.length > 0 ? (
                ...
                <p className="justify-center items-center flex text-white m-0 font-semibold">
                  ...
                  {busy
                    ? "Converting…"
                    : "Cut-ready SVG previews appear here..."}
                </p>
              )}
            </div>
          </section>
        ...
        <article className="max-w-none">
          <header className="rounded-2xl border border-slate-200 bg-gradient-to-b from-sky-50 to-white p-6 md:p-8">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-slate-600">
                Turn a PNG or JPG into one editable SVG color that you can
                inspect in Cricut Design Space. This page is tuned for common US
                craft projects: vinyl decals, heat-transfer vinyl shirts, pantry
                labels, party cutouts, classroom projects, small business
                packaging, silhouettes, and simple sticker outlines.
              </p>
              <p className="text-slate-600">
                Use the Cricut-focused presets first, then open Advanced
                settings when you need tighter curves, fewer speckles, stronger
                outlines, or a dark preview for white vinyl designs. This tool
                does not preserve full original colors or create layered vinyl
                SVGs; use dedicated layered or Print Then Cut tools for those
                workflows.
              </p>

              <div className="mt-2 grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
                {[
                  { k: "Craft presets", v: "Decals, HTV, labels, stencils" },
                  { k: "Single-color cut SVG", v: "Editable path output" },
                  { k: "Live preview", v: "Fast tuning before export" },
                  {
                    k: "Transparent default",
                    v: "Useful for Design Space import",
                  },
                ].map((x) => (
                  <div
                    key={x.k}
          ...
          <section className="mt-8">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {[
                "Vinyl decals",
                "HTV shirt graphics",
                "Cup and tumbler decals",
                "Pantry labels",
                "Simple sticker outlines",
                "Party decorations",
                "Classroom cutouts",
            ...
            <div className="mt-4 grid md:grid-cols-3 gap-4">
              <div className="rounded-2xl border border-slate-200 p-5">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Start with “Cricut - Clean Cut” or “Vinyl Decal - Bold”. Raise
                  turd size if the design has dust, dots, or scanner noise.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 p-5">
                <div className="text-sm font-semibold text-sky-950">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Use “Shirts / HTV - Smooth” when you want simpler curves and
                  fewer tiny cut pieces that are hard to weed.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 p-5">
                <div className="text-sm font-semibold text-sky-950">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Use “Sticker / Outline Trace” when you want a bolder
                  single-color contour. This page does not preserve the original
                  printed colors.
                </p>
              </div>
            </div>
          ...
          <section className="mt-8 rounded-2xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-sm text-slate-600">
              This page traces your PNG or JPG into one editable SVG color. It
              works best for decals, silhouettes, text art, labels, HTV designs,
              stencils, and simple logos. It is not meant to preserve every
              original color from the image or build separate color layers.
            </p>
            <div className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-4 text-sm text-slate-700">
              <strong className="text-sky-950">
                Need layered colors or Print Then Cut?
              </strong>{" "}
          ...
          >
            <div className="flex items-end justify-between gap-4 flex-wrap">
              ...
              <span className="text-xs text-slate-500">
                Upload → choose Cricut preset → tune → download SVG
              </span>
            </div>
              ...
              {[
                {
                  ...
                  body: "Use a high-contrast image when possible. Simple artwork, text graphics, logos, and silhouettes usually vectorize better than busy photos.",
                },
                {
                  title: "Choose a Cricut-focused preset",
                  body: "Start with Clean Cut for general craft use, Bold for vinyl decals, Smooth for HTV shirts, or Strong Outline for stickers.",
                },
                {
                  title: "Tune the cut file",
                  body: "Use threshold to control what becomes solid, turd size to remove speckles, and curve tolerance to balance detail against simpler paths.",
                },
                {
                  title:
                    "Keep transparency unless you need a preview background",
                  body: "Transparent SVG output is usually the safest starting point for Cricut Design Space. Use dark preview only when checking white vinyl artwork.",
                },
                {
                  title: "Download the SVG and inspect it in Design Space",
                  body: "The converter creates editable SVG paths. Always preview the final layers and cut behavior before using expensive vinyl, cardstock, or printable sticker paper.",
                },
              ].map((s, i) => (
                <li
                  key={s.title}
          ...
          <section className="mt-12">
            ...
            <p className="mt-2 text-sm text-slate-600 max-w-[82ch]">
              The presets are tuned for craft outcomes, not just generic image
              tracing. The goal is a practical SVG that is easier to inspect,
              edit, and cut.
            </p>
            ...
            <div className="mt-5 grid md:grid-cols-2 gap-4">
              {[
                {
                  title: "Cricut - Clean Cut",
                  body: "Best first choice for silhouettes, simple PNG graphics, and everyday craft designs.",
                },
                {
                  title: "Vinyl Decal - Bold",
                  body: "Makes stronger filled shapes and removes more small debris, which helps with decal-style artwork.",
                },
                {
                  title: "Shirts / HTV - Smooth",
                  body: "Simplifies curves so heat-transfer vinyl artwork is less fussy to weed and press.",
                },
                {
                  title: "Sticker / Outline Trace",
                  body: "Extracts stronger contours from artwork when you want a bolder sticker-like trace.",
                },
                {
                  title: "Scan - Remove Speckles",
                  body: "Useful for hand-drawn art, scanned lettering, and paper sketches with dust or small marks.",
                },
                {
                  title: "White Vinyl - Dark Preview",
                  body: "Adds a dark background preview and white paths so white vinyl designs are visible before download.",
                },
              ].map((c) => (
                <div
                  key={c.title}
          ...
          <section className="mt-12">
            ...
            <p className="mt-2 text-sm text-slate-600 max-w-[82ch]">
              These controls matter when your SVG imports with too many tiny
              pieces, weak edges, chunky curves, or unwanted marks.
            </p>
            ...
            <div className="mt-5 grid md:grid-cols-2 gap-4">
              {[
                {
                  title: "Threshold",
                  body: "Higher values include lighter parts of the image. Lower values keep only darker ink. This is the main control for how much of the PNG becomes a cut shape.",
                },
                {
                  title: "Turd size",
                  body: "Removes small islands, speckles, and dust. Increase it for scanned drawings or noisy JPEGs. Decrease it if tiny details are being removed.",
                },
                {
                  title: "Curve tolerance",
                  body: "Higher values smooth and simplify paths. Lower values preserve more detail but can create heavier SVGs with more nodes.",
                },
                {
                  title: "Turn policy",
                  body: "Controls how ambiguous corners are resolved. Majority is a stable default. Black can help close gaps in bolder decal artwork.",
                },
                {
                  title: "Preprocess",
                  body: "Use None for logos, text, and crisp graphics. Use Edge for photos, hand drawings, and designs where you want outlines instead of filled silhouettes.",
                },
                {
                  title: "Line color and background",
                  body: "Keep black paths on a transparent background for most imports. Use white-on-dark preview only to check white vinyl visibility.",
                },
              ].map((c) => (
                <div
                  key={c.title}
          ...
          <section className="mt-12">
            ...
            <div className="mt-4 grid lg:grid-cols-3 gap-4">
              <div className="lg:col-span-2 rounded-2xl border border-slate-200 bg-white p-5">
                <div className="text-sm font-semibold text-sky-950">
                  Better input gives better SVG output
                </div>
                <ul className="mt-3 grid gap-2 text-sm text-slate-600 list-disc pl-5">
                  <li>
                  ...
                  <li>
                    Avoid tiny distressed textures if the design needs to weed
                    cleanly.
                  </li>
                  <li>
                    Use bolder presets for decals and smoother presets for
                    shirts.
                  </li>
                  <li>
                    Inspect the imported SVG before cutting premium vinyl or
                    sticker paper.
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-sky-50 p-5">
                ...
                <p className="mt-2 text-sm text-slate-700">
                  iLoveSVG is not affiliated with Cricut. This page creates SVG
                  files that can be tested in Cricut Design Space, but final
                  cutting behavior depends on your artwork, material, blade,
                  mat, and Design Space setup.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mt-12">
            ...
            <div className="mt-4 grid lg:grid-cols-3 gap-4">
              <div className="lg:col-span-2 rounded-2xl border border-slate-200 bg-white p-5">
                <div className="text-sm font-semibold text-sky-950">Specs</div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                <div className="text-sm font-semibold text-sky-950">
                  Stable free conversion
                </div>
                <p className="mt-2 text-sm text-slate-700">
                  Vectorization is CPU heavy, so conversions are queued when the
                  server is busy. The app uses <code>Retry-After</code> handling
          ...
          >
            ...
            <div className="mt-4 grid gap-3">
              {[
                {
                  q: "Can I use this SVG in Cricut Design Space?",
                  a: "The tool creates standard single-color SVG output that you can test in Cricut Design Space. Always inspect sizing and cut behavior before using paid materials.",
                },
                {
                  q: "Will this preserve the colors from my PNG?",
                  a: "No. This page is built for single-color cut SVGs. It traces the image into one editable SVG color, which is better for vinyl, HTV, decals, stencils, labels, and silhouettes.",
                },
                {
                  q: "Is this an official Cricut converter?",
                  a: "No. iLoveSVG is independent and is not affiliated with Cricut. The page is tuned for common single-color Cricut-style cut workflows.",
                },
                {
                  q: "What images work best?",
                  a: "High-contrast logos, silhouettes, lettering, simple drawings, and clean PNG graphics usually work best. Busy photos often need manual cleanup after vectorization.",
                },
                {
                  q: "Should I use transparent background?",
                  a: "Usually yes. Transparent output is the safest default for importing artwork. Use a background color only when you need a preview or a specific visual export.",
                },
                {
                  q: "What file limits apply?",
                  a: "PNG and JPEG files are accepted up to 30 MB and roughly 30 megapixels. Preview is fastest under 10 MB and throttled up to 25 MB.",
                },
                {
                  q: "Why does my SVG have many small shapes?",
                  a: "Raster-to-vector tracing follows pixel detail. Increase turd size, use a smoother preset, or simplify the original PNG before converting.",
                },
              ].map((x) => (
                <article
                  key={x.q}
