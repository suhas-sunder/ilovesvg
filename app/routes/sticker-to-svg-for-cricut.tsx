...
async function traceActionImplementation({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    if (!file || typeof file === "string") {
      return responseJson({ error: "No sticker image uploaded." }, { status: 400 });
    }
...
export default function StickerToSvgForCricut({}: Route.ComponentProps) {
  const fetcher = useHybridTraceFetcher<ServerResult>({ routeId: "sticker-to-svg-for-cricut" });
        ...
        <div className="mx-auto max-w-[1180px] px-4">
          ...
          <section className="grid grid-cols-1 gap-4 items-start sm:pt-5 md:grid-cols-2 lg:pt-0 lg:pb-8">
            ...
            <TraceOutputPanel
              ...
              downloadFileName="sticker-to-svg-for-cricut.svg"
