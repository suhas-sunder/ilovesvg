...
const routeCapabilities = getRouteCapabilities("photo-to-svg-for-cricut");
...
export default function Home({ loaderData }: Route.ComponentProps) {
  const fetcher = useHybridTraceFetcher<ServerResult>({ routeId: "photo-to-svg-for-cricut" });
        ...
        <div className="max-w-[1180px] mx-auto px-4">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start sm:pt-6 lg:pt-0 lg:pb-8">
            ...
            <TraceOutputPanel
              ...
              downloadFileName="photo-to-svg-for-cricut.svg"
        ...
        <article className="max-w-none">
          ...
          <section className="mt-12">
            ...
            <p className="mt-2 text-sm text-slate-600 max-w-[80ch]">
              ...
              settings only when the preview needs cleanup.
            </p>
