...
import type { Route } from "./+types/png-to-svg-for-cricut-vinyl";
import {
  json,
...
export function meta({}: Route.MetaArgs) {
  const title =
    "PNG to SVG for Cricut Vinyl Vinyl | Free Vinyl Cut File Converter";
  const description =
    "Convert PNG and JPG designs into clean single-color SVG cut files for Cricut vinyl projects. Tune presets for decals, labels, stickers, signs, stencils, and easy-weeding vinyl cuts.";
...
const PRESETS: Preset[] = [
  ...
  {
    id: "vinyl-clean-weed",
    label: "Vinyl  -  Clean Weed (default)",
    settings: {
      preprocess: "none",
      threshold: 218,
      turdSize: 5,
  ...
  {
    id: "permanent-decal-bold",
    label: "Permanent Vinyl  -  Bold Decal",
    settings: {
      preprocess: "none",
      threshold: 212,
      turdSize: 5,
  ...
  {
    id: "removable-wall-decal",
    label: "Removable Vinyl  -  Wall Decal",
    settings: {
      preprocess: "none",
      threshold: 220,
      turdSize: 4,
  ...
  {
    id: "small-decal-clean",
    label: "Small Decal  -  Reduce Tiny Cuts",
    settings: {
      preprocess: "none",
      threshold: 216,
      turdSize: 7,
  ...
  {
    id: "stencil-vinyl",
    label: "Stencil Vinyl  -  Solid Shapes",
    settings: {
      preprocess: "none",
      threshold: 208,
      turdSize: 6,
  ...
  {
    id: "hand-drawn-vinyl",
    label: "Hand Drawn  -  Vinyl Outline",
    settings: {
      preprocess: "edge",
      blurSigma: 1.0,
      edgeBoost: 1.25,
...
const routeCapabilities = getRouteCapabilities("png-to-svg-for-cricut-vinyl");
...
function autoModeHint(mode: AutoMode): string {
  if (mode === "medium")
    return "Live preview is throttled for 10-25 MB vinyl artwork.";
  return "";
}
function autoModeDetail(mode: AutoMode): string {
  if (mode === "medium")
    return "Large vinyl artwork updates run less frequently to keep tracing stable.";
  return "";
}
...
export default function Home({ loaderData }: Route.ComponentProps) {
  ...
  async function handleNewFile(f: File) {
    ...
    if (chosen.size > LIVE_MED_MAX) {
      try {
        setInfo(
          "Large file detected. Compressing locally before vinyl preview...",
        );
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start sm:pt-6 lg:pt-0 lg:pb-8">
            ...
            <div className="bg-white sm:border sm:border-slate-200 rounded-xl p-4 sm:shadow-sm overflow-hidden min-w-0">
              ...
              <p className="mb-3 text-sm text-slate-600 text-center">
                Create a single-color vinyl cut SVG from PNG or JPG artwork.
                Best for decals, labels, signs, cup designs, car/window decals,
                stencils, and simple easy-weeding vinyl projects.
              </p>
              ...
              <div className="flex items-center gap-3 mt-3 flex-wrap">
                ...
                >
                  <Icons
                    ...
                    title="Convert"
                  />
                  {busy ? "Converting…" : "Convert to Vinyl SVG"}
                </button>
              ...
              {previewUrl && (
                <div className="hidden md:flex flex-col mt-3 border border-slate-200 rounded-xl overflow-hidden bg-white">
                  <p className="text-slate-700 ml-2 mt-1">
                    {" "}
                    Original Vinyl Artwork Preview:
                  </p>
                  <img
                    src={previewUrl}
                    alt="Input"
            ...
            <div className="bg-slate-600 border border-slate-200 rounded-xl p-4 h-full max-h-[124.25em] overflow-auto shadow-sm min-w-0">
              ...
              {history.length > 0 ? (
                      ...
                      <div className="flex gap-2 flex-wrap my-2">
                        <button
                          ...
                          onClick={() => {
                            ...
                            a.href = u;
                            a.download = "cricut-vinyl-cut.svg";
                ...
                <p className="justify-center items-center flex text-white m-0 font-semibold">
                  ...
                  {busy
                    ? "Converting…"
                    : "Vinyl cut SVG previews appear here..."}
                </p>
              )}
            </div>
          </section>
        ...
        <article className="max-w-none">
          <header className="rounded-2xl border border-slate-200 bg-gradient-to-b from-sky-50 to-white p-6 md:p-8">
            <div className="flex flex-col gap-3">
              ...
              <h2 className="text-sky-950 text-2xl md:text-3xl font-bold leading-tight">
                Make cleaner vinyl cut files for decals, labels, signs, cups,
                and stencils
              </h2>
              <p className="text-slate-600">
                This converter turns a PNG or JPG into a single-color SVG cut
                file for Cricut vinyl workflows. It is tuned for practical vinyl
                projects where clean outlines, fewer tiny pieces, and smoother
                curves matter more than preserving every color from the original
                image.
              </p>
              <p className="text-slate-600">
                Use it for permanent vinyl decals, removable vinyl wall
                graphics, pantry labels, car/window decals, tumbler designs,
                stencil vinyl, and simple small business graphics. Start with
                the vinyl presets, then adjust the advanced settings if the cut
                has too many speckles or rough edges.
              </p>

              <div className="mt-2 grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
                {[
                  { k: "Easy weeding", v: "Reduce small nuisance cuts" },
                  { k: "Vinyl presets", v: "Decals, labels, stencils" },
                  { k: "Single-color SVG", v: "Best for cut paths" },
                  {
                    k: "Transparent default",
                    v: "Cleaner Design Space import",
                  },
                ].map((x) => (
                  <div
                    key={x.k}
          ...
          <section className="mt-8 rounded-2xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-sm text-slate-600">
              This page creates one-color SVG paths for vinyl cutting. It works
              best for decals, text art, labels, simple logos, silhouettes,
              stencil designs, and clean high-contrast graphics. It is not a
              layered color SVG tool and it does not preserve full PNG colors
              for Print Then Cut.
            </p>
          </section>

          <section className="mt-8">
            <h3 className="text-sky-950 text-lg font-bold">Best vinyl uses</h3>
            <div className="mt-3 flex flex-wrap gap-2">
              {[
                "Permanent vinyl decals",
            ...
            <div className="mt-4 grid md:grid-cols-3 gap-4">
              <div className="rounded-2xl border border-slate-200 p-5">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Use “Vinyl - Clean Weed” or “Permanent Vinyl - Bold Decal”
                  when you want stronger shapes and fewer fragile pieces.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 p-5">
                <div className="text-sm font-semibold text-sky-950">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Use “Lettering / Labels - Sharp” for text-heavy designs, then
                  raise turd size if the output has tiny islands.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 p-5">
                <div className="text-sm font-semibold text-sky-950">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Use “Small Decal - Reduce Tiny Cuts” when your design creates
                  small fragments that would be hard to weed or transfer.
                </p>
              </div>
            </div>
          </section>
          ...
          >
            <div className="flex items-end justify-between gap-4 flex-wrap">
              ...
              <span className="text-xs text-slate-500">
                Upload → choose vinyl preset → simplify cuts → download SVG
              </span>
            </div>
              ...
              {[
                {
                  ...
                  body: "Use simple, high-contrast artwork when possible. Vinyl cuts are cleaner when the source image has clear edges and limited noise.",
                },
                {
                  title: "Choose a vinyl preset",
                  body: "Start with Clean Weed for general vinyl, Bold Decal for permanent vinyl, or Lettering / Labels for text-heavy designs.",
                },
                {
                  title: "Remove speckles and tiny cut pieces",
                  body: "Raise turd size to remove dust and small islands. Increase curve tolerance when you want smoother paths and easier weeding.",
                },
                {
                  title: "Keep transparent output for Design Space",
                  body: "Transparent SVG output is usually the safest starting point for vinyl cut files. Use white vinyl dark preview only to inspect light designs.",
                },
                {
                  title: "Download and inspect before cutting",
                  body: "Open the SVG in Cricut Design Space and check the final cut behavior before using expensive vinyl, transfer tape, or specialty material.",
                },
              ].map((s, i) => (
                <li
                  key={s.title}
          ...
          <section className="mt-12">
            ...
            <p className="mt-2 text-sm text-slate-600 max-w-[82ch]">
              These presets are tuned around vinyl cutting outcomes: cleaner
              paths, fewer small pieces, and easier weeding. They are not meant
              to preserve every image color.
            </p>

            <div className="mt-5 grid md:grid-cols-2 gap-4">
              {[
                {
                  title: "Vinyl - Clean Weed",
                  body: "Best first choice for general decals, labels, silhouettes, and simple graphics.",
                },
                {
                  title: "Permanent Vinyl - Bold Decal",
                  body: "Creates stronger filled shapes for outdoor decals, tumblers, signs, and high-contrast artwork.",
                },
                {
                  title: "Small Decal - Reduce Tiny Cuts",
                  body: "Simplifies small designs so they are less likely to create painful weeding work.",
                },
                {
                  title: "Lettering / Labels - Sharp",
                  body: "Keeps sharper text and thin lines for pantry labels, shop labels, and lettering-heavy graphics.",
                },
                {
                  title: "Stencil Vinyl - Solid Shapes",
                  body: "Useful for stencil-style graphics where stronger solid areas matter more than fine detail.",
                },
                {
                  title: "White Vinyl - Dark Preview",
                  body: "Shows white vinyl paths on a dark background so you can inspect the design before export.",
                },
              ].map((c) => (
                <div
                  key={c.title}
          ...
          <section className="mt-12">
            ...
            <div className="mt-5 grid md:grid-cols-2 gap-4">
              {[
                {
                  title: "Threshold",
                  body: "Controls what becomes vinyl. Higher includes lighter pixels; lower keeps only darker, stronger shapes.",
                },
                {
                  title: "Turd size",
                  body: "Removes tiny speckles and fragments that usually become annoying cuts or weeding leftovers.",
                },
                {
                  title: "Curve tolerance",
                  body: "Higher values smooth paths and reduce complexity. Lower values keep more detail but may create fussy cuts.",
                },
                {
                  title: "Turn policy",
                  body: "Changes how ambiguous corners are resolved. Majority is usually safer for vinyl, while black can make bolder filled shapes.",
                },
                {
                  title: "Preprocess",
                  body: "Use None for logos, text, labels, and clean art. Use Edge only when tracing a photo, sketch, or low-contrast source.",
                },
                {
                  title: "Line color and background",
                  body: "Choose a vinyl preview color. Keep transparency for export, or use a background only when previewing white vinyl.",
                },
              ].map((c) => (
                <div
                  key={c.title}
          ...
          <section className="mt-12 rounded-2xl border border-amber-200 bg-amber-50 p-5">
            ...
            <p className="mt-2 text-sm text-slate-700">
              This page creates a single-color vector cut file. It is the right
              workflow for vinyl decals, labels, signs, stencils, and
              silhouettes. Use a layered SVG converter when you need separate
              vinyl colors, and use a Print Then Cut workflow when you need
          ...
          <section className="mt-12">
            ...
            <div className="mt-4 grid gap-3">
              {[
                {
                  q: "Will this preserve the original PNG colors?",
                  a: "No. This vinyl converter creates a single-color SVG cut file. That is intentional because vinyl cutting usually depends on clean paths, not full-color image preservation.",
                },
                {
                  q: "Can I use this for permanent vinyl decals?",
                  a: "Yes. Use the Permanent Vinyl preset when you want stronger filled shapes for decals, tumblers, signs, and outdoor-style graphics.",
                },
                {
                  q: "How do I make the SVG easier to weed?",
                  a: "Use the Clean Weed or Small Decal preset. You can also raise turd size and curve tolerance to remove tiny fragments and simplify paths.",
                },
                {
                  q: "Why did small details disappear?",
                  a: "The vinyl presets intentionally remove tiny pieces that are hard to cut, weed, or transfer. Lower turd size and curve tolerance if those details are important.",
                },
                {
                  q: "Can I use this for HTV shirts?",
                  a: "Yes, for simple one-color heat-transfer vinyl designs. For multi-color HTV, use a layered SVG workflow instead.",
                },
                {
                  q: "Is this affiliated with Cricut?",
                  a: "No. iLoveSVG is an independent SVG utility site and is not affiliated with Cricut or Design Space.",
                },
              ].map((item) => (
                <details
                  key={item.q}
