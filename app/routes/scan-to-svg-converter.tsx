              ...
              <div className="mt-3 flex flex-col gap-2 min-w-0">
                <Field label="Preprocess">
                  ...
                  >
                    ...
                    <option value="edge">Edge (hard cases)</option>
                  </select>
                </Field>
      ...
      <div className="max-w-[1180px] mx-auto px-4 h-12 flex items-center justify-between">
        ...
        <nav aria-label="Primary">
          <ul className="flex items-center gap-4 text-[14px] font-semibold">
            ...
            <li>
              <a href="/photo-to-svg-outline" className="text-slate-700 hover:text-slate-900 transition-colors">
                Photo Outline
              </a>
            </li>
            <li>
              <a href="/image-to-svg-outline" className="text-slate-700 hover:text-slate-900 transition-colors">
                Image Outline
              </a>
            </li>
            <li>
