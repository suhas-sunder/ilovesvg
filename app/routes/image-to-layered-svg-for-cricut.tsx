...
export default function ImageToLayeredSvgForCricut({
  ...
  const fetcher = useHybridTraceFetcher<ServerResult>({ routeId: "image-to-layered-svg-for-cricut" });
        ...
        <div className="max-w-[1180px] mx-auto px-4">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start sm:pt-6 lg:pt-0 lg:pb-8">
              ...
              <div className="flex items-center gap-3 mt-3 flex-wrap">
                ...
                >
                  <Icons
                    ...
                    title="Convert"
                  />
                  {busy ? "Building layersâ€¦" : "Convert to Layered SVG"}
                </button>
            ...
            <BespokeTraceOutputPanel
              ...
              downloadFileName="image-to-layered-svg-for-cricut.svg"
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="text-xs text-slate-500">
            Original {layer.originalColor.toUpperCase()} â€¢ current {localColor.toUpperCase()} â€¢ {layer.pixelPercent}% of traced pixels
          </div>
        </div>
          ...
          >
            <div className="flex items-end justify-between gap-4">
              ...
              <span className="text-xs text-slate-500">
                Upload â†’ choose layer preset â†’ edit colors â†’ download
              </span>
            </div>
