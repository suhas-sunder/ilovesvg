            ...
            <ol className="mt-4 grid gap-3">
              {[
                ...
                },
                {
                  ...
                  body: "Use threshold to control what becomes solid, turd size to remove tiny JPEG speckles, and curve tolerance to balance detail against smoother cutting paths.",
                },
                {
