...
export default function WebpToSvgConverter({
  ...
  function submitOutputUpdate(stamp: number) {
    ...
    void submitConvertWithSettings(nextSettings, stamp);
  }
        ...
        <div className="max-w-[1180px] mx-auto px-4">
          ...
          <section className="grid grid-cols-1 gap-4 items-start sm:pt-5 md:grid-cols-2 lg:pt-0 lg:pb-8">
            ...
            <TraceOutputPanel
              ...
              downloadFileName="webp-to-svg.svg"
              emptyTitle="Converted WebP SVG files appear here..."
              emptyDescription="Convert your WebP image to preview, copy, or download the result."
