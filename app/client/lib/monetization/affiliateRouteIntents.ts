...
export const ROUTE_AFFILIATE_INTENTS: Record<string, AffiliateCategory[]> = {
  ...
  "/svg-to-png-converter": ["web-design", "general-svg-conversion"],
  "/svg-to-jpg-converter": ["web-design", "general-svg-conversion"],
  "/svg-to-webp-converter": ["technical-utility"],
  "/svg-to-pdf-converter": ["technical-utility"],

  "/svg-background-editor": ["web-design", "technical-utility"],
  "/svg-resize-and-scale-editor": ["web-design", "technical-utility"],
  "/svg-recolor": ["web-design", "technical-utility"],
  ...
  "/gif-to-svg-converter": ["general-svg-conversion"],
  "/avif-to-svg-converter": ["general-svg-conversion"],
  ...
  "/transparent-png-to-svg-converter": ["general-svg-conversion", "stickers"],
